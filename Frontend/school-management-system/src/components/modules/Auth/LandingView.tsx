    ...
    <div className="h-screen w-screen overflow-hidden relative flex flex-col font-sans">
      ...
      <div className="absolute top-6 right-6 sm:top-10 sm:right-10 z-20">
        <button 
          ...
          className="px-6 py-3 bg-white text-indigo-900 font-bold rounded-xl text-sm sm:text-base shadow-lg hover:scale-105 hover:shadow-xl hover:bg-indigo-50 transition-all duration-300 flex items-center gap-2 group"
        >
          Sign In
      ...
      <div className="relative z-10 w-full flex-1 flex flex-col justify-center px-6 sm:px-12 lg:px-32 animate-in slide-in-from-left-8 duration-1000 fade-in pt-12">
        ...
        <div className="w-12 h-12 sm:w-16 sm:h-16 lg:w-20 lg:h-20 rounded-2xl bg-gradient-to-br from-indigo-500 to-violet-600 flex items-center justify-center text-white shadow-xl shadow-indigo-500/30 mb-6 shrink-0">
        ...
        <h1 className="font-black text-white tracking-tight leading-[1.1] drop-shadow-lg mb-4 sm:mb-6 text-[clamp(2.5rem,7vh,5rem)] xl:text-[clamp(3.5rem,8vh,6rem)]">
          Pirnav <br />
          <span className="text-transparent bg-clip-text bg-gradient-to-r from-indigo-300 to-violet-300">Educational</span> <br />
          Institution
        </h1>
        
        <p className="font-medium max-w-xl drop-shadow-md leading-relaxed border-l-4 border-indigo-500 pl-4 text-slate-300 text-[clamp(0.875rem,2vh,1.125rem)] xl:text-[clamp(1rem,2vh,1.25rem)]">
