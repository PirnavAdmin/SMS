...
export const WardenDashboardView: React.FC<WardenDashboardViewProps> = ({
  ...
  return (
    <div className="space-y-6 animate-in fade-in pb-12">
      {/* 1. Header Banner */}
      <div className="glass-card p-5 rounded-3xl border border-slate-200/80 dark:border-slate-800 bg-gradient-to-r from-sky-900 via-indigo-900 to-slate-900 text-white shadow-xl relative overflow-hidden">
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-4">
          <div className="space-y-1.5">
            <div className="flex items-center gap-2">
              <span className="px-3 py-1 rounded-full bg-sky-500/20 text-sky-300 font-extrabold text-[11px] border border-sky-400/30 uppercase tracking-wider">
          ...
          <div className="flex items-center gap-3 shrink-0">
            <button
              ...
              className="px-4 py-2.5 rounded-2xl bg-white text-slate-900 hover:bg-slate-100 text-xs font-black shadow-lg transition-all flex items-center gap-2 cursor-pointer"
            >
              <Building2 className="w-4 h-4 text-sky-600" /> Manage Hostel
            </button>
          </div>
        </div>
        ...
        <div className="absolute left-1/3 -top-10 w-40 h-40 rounded-full bg-indigo-500/10 blur-xl pointer-events-none" />
      </div>
