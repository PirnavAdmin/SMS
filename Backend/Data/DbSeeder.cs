...
namespace SMS.Api.Data
{
    public static class DbSeeder
    {
        public static async Task SeedAsync(IServiceProvider serviceProvider)
        {
            ...
            // Apply any pending EF Core migrations automatically (Bypassed to prevent legacy script conflicts)
            // try
            // {
            ...
            {
                Console.WriteLine($"Role Seed Notice: {ex.Message}");
            }

            // 2. Seed Default Super Admin & Admin Users
            try
            {
            ...
            {
                Console.WriteLine($"User Seed Notice: {ex.Message}");
            }
            ...
            {
                Console.WriteLine($"LeaveType Seed Notice: {ex.Message}");
            }
            ...
            {
                Console.WriteLine($"Homework Seed Notice: {ex.Message}");
            }
            ...
            {
                Console.WriteLine($"Circulars/Meetings Seed Notice: {ex.Message}");
            }
            ...
            {
                Console.WriteLine($"SchoolEvents Seed Notice: {ex.Message}");
            }
            ...
            {
                Console.WriteLine($"Payroll/Payslips Seed Notice: {ex.Message}");
            }
        }
    }
}