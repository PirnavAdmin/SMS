...
using (var scope = app.Services.CreateScope())
{
    ...
    try
    {
        ...
        var tableSqls = new[]
        {
            ...
            @"CREATE TABLE IF NOT EXISTS `transport_attendants` (
                `AttendantId` bigint NOT NULL AUTO_INCREMENT,
                `AttendantName` varchar(150) NOT NULL,
                `MobileNumber` varchar(30) NOT NULL,
                `EmployeeId` varchar(50) NULL,
                `Gender` varchar(20) NULL,
                `BranchName` varchar(100) NULL,
                `AlternateMobileNumber` varchar(30) NULL,
...
#pragma warning restore EF1002
        ...
        EnsureColumnExists("transport_drivers", "LicenceNumber", "varchar(50) NULL");
        EnsureColumnExists("transport_drivers", "LicenceExpiry", "datetime(6) NULL");
        EnsureColumnExists("transport_drivers", "AlternateMobileNumber", "varchar(20) NULL");
        EnsureColumnExists("transport_drivers", "Email", "varchar(100) NULL");
        EnsureColumnExists("transport_drivers", "Address", "varchar(255) NULL");
        EnsureColumnExists("transport_drivers", "BloodGroup", "varchar(10) NULL");
        EnsureColumnExists("transport_drivers", "EmergencyContactName", "varchar(100) NULL");
...
// =========================================================
        ...
        EnsureColumnExists("transport_attendants", "BranchName", "varchar(100) NULL");
        EnsureColumnExists("transport_attendants", "AlternateMobileNumber", "varchar(30) NULL");
        EnsureColumnExists("transport_attendants", "Address", "varchar(255) NULL");
        EnsureColumnExists("transport_attendants", "BloodGroup", "varchar(10) NULL");
        ...
        EnsureColumnExists("transport_vehicle_assignments", "AcademicYear", "varchar(50) NULL");
        EnsureColumnExists("transport_vehicle_assignments", "MorningTripTime", "varchar(50) NULL");
        EnsureColumnExists("transport_vehicle_assignments", "EveningTripTime", "varchar(50) NULL");
        EnsureColumnExists("transport_vehicle_assignments", "AssignmentDate", "datetime(6) NOT NULL DEFAULT CURRENT_TIMESTAMP(6)");
        ...
        try
        {
            ...
            // Mock staff sync removed - staff are managed directly through the database.
